...
def get_list_of_patients(base_dir):
    mri_directory = os.path.join(base_dir, "imagesTr")
    mri_files = subfiles(mri_directory, prefix="prostate", join=False)
    patients = list(map(get_patient_from_filename, mri_files))
    return patients
